define('ace/mode/bbscript_highlight_rules', [
  'require',
  'exports',
  'module',
  'ace/lib/oop',
    ...
    this.vbsBlock = function (session, row, column, tokenRange) {
      ...
      switch (val) {
        ...
        case 'with':
          ...
          var endTest = /^\s*End\s(If|Sub|Select|Function|Class|With|Property)\s*/i.test(
            line
          );
...
define('ace/mode/vbscript', [
  ...
  'ace/lib/oop',
  'ace/mode/text',
  'ace/mode/bbscript_highlight_rules',
  ...
  var VBScriptHighlightRules = require('./bbscript_highlight_rules')
    .VBScriptHighlightRules;
